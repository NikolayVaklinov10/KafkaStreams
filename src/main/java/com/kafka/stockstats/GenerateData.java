...
import com.kafka.stockstats.model.PageView;
import com.kafka.stockstats.model.Search;
import com.kafka.stockstats.model.UserProfile;
...
public class GenerateData {
    ...
    public static void main(String [] args) throws Exception {
        ...
        System.out.println("Press CTRL_C to stop generating data");
